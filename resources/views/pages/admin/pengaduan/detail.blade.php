        ...
        <div class="px-4 py-3 mb-8 flex text-gray-800 bg-white rounded-lg shadow-md dark:bg-gray-800">
          <div class="relative hidden mr-3  md:block dark:text-gray-400">
            ...
            <div class="flex justify-center my-4">
              <a href="{{ Storage::url($item->image) }}"  class="px-5 py-3 font-medium leading-5 text-white transition-colors duration-150 bg-red-600 border border-transparent rounded-lg active:bg-red-600 hover:bg-red-700 focus:outline-none focus:shadow-outline-red"  download="">Download Foto</a>
            </div>
            </div>
          ...
          <div class="text-center flex-1 dark:text-gray-400">
            <h1 class="mb-8 font-semibold">Dokumen</h1>
            <p class="text-gray-800 dark:text-gray-400" src="{{ Storage::url($item->dokumen) }}" alt="" loading="lazy"></p>
            <a href="{{ Storage::url($item->dokumen) }}" class="px-5 py-3 font-medium leading-5 text-white transition-colors duration-150 bg-red-600 border border-transparent rounded-lg active:bg-red-600 hover:bg-red-700 focus:outline-none focus:shadow-outline-red"  download="">Download Dokumen</a>
          </div>
